...
fm_test_write_brief "$HOME_DIR/data/anchor/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/shape/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/order-a/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/order-b/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/order-fail/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/fm-hibit-resume-r1/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/wheelhouse-healing-r1/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/active-seeded/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/abort-a/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/abort-b/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/lock-contended/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/default-on/brief.md" no-mistakes
...
for ROUND in 1 2 3; do
  ...
  fm_test_write_brief "$HOME_DIR/data/focus-$ROUND-a/brief.md" no-mistakes
  fm_test_write_brief "$HOME_DIR/data/focus-$ROUND-b/brief.md" no-mistakes
...
fm_test_write_brief "$HOME_DIR/data/p1/brief.md" no-mistakes
fm_test_write_brief "$HOME_DIR/data/p2/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_A/data/a1/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_A/data/a2/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_B/data/b1/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_B/data/b2/brief.md" no-mistakes
...
fm_test_write_brief "$HOME_DIR/data/pcw/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_A/data/acw/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_B/data/bcw/brief.md" no-mistakes
...
fm_test_write_brief "$SECOND_HOME_A/data/aflat/brief.md" no-mistakes
...
fm_test_write_brief "$SECOND_HOME_A/data/$CROSS_RESTART_ID/brief.md" no-mistakes
...
fm_test_write_brief "$HOME_DIR/data/$PRIMARY_WAVE_ID/brief.md" no-mistakes
fm_test_write_brief "$SECOND_HOME_B/data/$BRAVO_WAVE_ID/brief.md" no-mistakes
...
fm_test_write_brief "$HOME_DIR/data/post-legacy/brief.md" no-mistakes
