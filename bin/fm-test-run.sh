...
family_for_basename() {
  case "$1" in
    ...
    fm-spawn-admit.test.sh|fm-spawn-brief-contract.test.sh|fm-spawn-dispatch-profile.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-brief.sh|bin/fm-brief-contract-lib.sh|bin/fm-ensure-agents-md.sh|bin/fm-crew-state.sh|\
